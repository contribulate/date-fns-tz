...
describe('tzTokenizeDate', function () {
  ...
  it('returns milliseconds', function () {
    var result = tzTokenizeDate(new Date('2014-10-25T13:46:20.123Z'), 'UTC')
    assert.deepEqual(result, [2014, 10, 25, 13, 46, 20, 123])
  })
